# generate_masjid_al_khaif.py — thin orchestrator for model "Masjid Al-Khaif (Mina)".
# Run: blender --background --factory-startup --python models/masjid-al-khaif/generate_masjid_al_khaif.py
import sys, os
...
def main():
    ...
    print(f"\n{C.TAG} ===== BUILD SUMMARY (Masjid Al-Khaif (Mina)) =====")
    overall = "OK"
