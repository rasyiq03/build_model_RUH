# AGENTS.md — RUH Model Spec: Masjid Yalamlam (Miqat)
...
Orchestrator: `generate_masjid-yalamlam.py` — its REGISTRY lists every component above.
...
One FBX per collection into `models/masjid-yalamlam/exports/`.
...
- [ ] `generate_masjid-yalamlam.py` runs from a clean Blender, zero tracebacks, OVERALL `OK`.
