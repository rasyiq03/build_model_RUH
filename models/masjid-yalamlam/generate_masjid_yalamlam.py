# generate_masjid_yalamlam.py — thin orchestrator for model "Masjid Yalamlam (Miqat)".
# Run: blender --background --factory-startup --python models/masjid-yalamlam/generate_masjid_yalamlam.py
import sys, os
...
def main():
    ...
    print(f"\n{C.TAG} ===== BUILD SUMMARY (Masjid Yalamlam (Miqat)) =====")
    overall = "OK"
