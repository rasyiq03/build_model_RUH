# AGENTS.md — RUH Model Spec: Masjid Bir Ali (Dhul Hulaifah Miqat)
...
Orchestrator: `generate_masjid-bir-ali.py` — its REGISTRY lists every component above.
...
One FBX per collection into `models/masjid-bir-ali/exports/`.
...
- [ ] `generate_masjid-bir-ali.py` runs from a clean Blender, zero tracebacks, OVERALL `OK`.
