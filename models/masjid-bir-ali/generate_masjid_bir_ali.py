# generate_masjid_bir_ali.py — thin orchestrator for model "Masjid Bir Ali (Dhul Hulaifah Miqat)".
# Run: blender --background --factory-startup --python models/masjid-bir-ali/generate_masjid_bir_ali.py
import sys, os
...
def main():
    ...
    print(f"\n{C.TAG} ===== BUILD SUMMARY (Masjid Bir Ali (Dhul Hulaifah Miqat)) =====")
    overall = "OK"
