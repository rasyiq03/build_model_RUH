# generate_masjid_al_nimrah.py — thin orchestrator for model "Masjid Al-Nimrah (Arafah)".
# Run: blender --background --factory-startup --python models/masjid-al-nimrah/generate_masjid_al_nimrah.py
import sys, os
...
def main():
    ...
    print(f"\n{C.TAG} ===== BUILD SUMMARY (Masjid Al-Nimrah (Arafah)) =====")
    overall = "OK"
