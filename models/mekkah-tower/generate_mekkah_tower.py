# generate_mekkah_tower.py — thin orchestrator for model "Makkah Royal Clock Tower (Abraj Al-Bait)".
# Run: blender --background --factory-startup --python models/mekkah-tower/generate_mekkah_tower.py
import sys, os
...
def main():
    ...
    print(f"\n{C.TAG} ===== BUILD SUMMARY (Makkah Royal Clock Tower (Abraj Al-Bait)) =====")
    overall = "OK"
